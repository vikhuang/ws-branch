"""各表的對帳(verify)函數——從 registry 切出(SRP 2026-09-22):registry 只宣告,這裡只檢查。

每個 verify:(n_samples, seed) → 印 PASS 或 raise SystemExit("FAIL: …")。抽樣、謂詞下推、
不做全史 unique(記憶體事故 ③)。
"""
...
def verify_t1(n_samples: int, seed: int) -> None:
...
def verify_t3(n_samples: int, seed: int) -> None:
...
def verify_t4(n_samples: int, seed: int) -> None:
...
def verify_t3b(n_samples: int, seed: int) -> None:
...
def verify_t4v3(n_samples: int, seed: int) -> None:
