...
>   代號+有效期,1520/1570/1380 退出日自 raw 查得;`cohort_expr()` 逐列解析;
>   建表 `assert_cohort_names(year=)` 強制驗證)。**9A81 永豐金-匯立不入 cohort**
>   (user 2026-09-21 拍板,`KNOWN_HIDDEN_FOREIGN`,讀本標「外資客戶*」)。
